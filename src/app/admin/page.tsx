...
import { demoStats, demoUsers } from '@/lib/demo-data';
        ...
        {activeTab === 'overview' && (
          <>
            ...
            <motion.div variants={item} className="grid grid-cols-2 lg:grid-cols-4 gap-4">
              {[
                { label: 'Total Users', value: demoStats.totalStudents.toLocaleString(), change: '+12.5%', icon: Users, color: 'from-indigo-500 to-blue-500', positive: true },
                { label: 'Total Posts', value: demoStats.totalPosts.toLocaleString(), change: '+8.2%', icon: MessageSquare, color: 'from-emerald-500 to-teal-500', positive: true },
                { label: 'Files Uploaded', value: demoStats.totalFiles.toString(), change: '+15.3%', icon: FileText, color: 'from-purple-500 to-pink-500', positive: true },
                { label: 'Active Chats', value: demoStats.activeChats.toString(), change: '+5.1%', icon: Activity, color: 'from-amber-500 to-orange-500', positive: true },
              ].map((stat) => (
